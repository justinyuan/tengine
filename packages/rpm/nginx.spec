...
Summary: Moko High performance web server
Name: moss
Version: 1.0.0
Release: 1%{?dist}.moko
Vendor: MOKO!
...
%description
moss is a HTTP server developed by MOKO! built on Tengine(TAOBAO.com Tengine)
...
%{__mv} $RPM_BUILD_ROOT%{_sysconfdir}/nginx/include $RPM_BUILD_ROOT%{_includedir}/nginx/
